...
public final class ActivityListHotelBinding implements ViewBinding {
  ...
  private ActivityListHotelBinding(@NonNull ConstraintLayout rootView,
      @NonNull RecyclerView rvHotel) {
  ...
  public static ActivityListHotelBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_list_hotel, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  public static ActivityListHotelBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityListHotelBinding((ConstraintLayout) rootView, rvHotel);
    }
